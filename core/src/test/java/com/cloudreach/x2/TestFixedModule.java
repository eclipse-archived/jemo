 ...
 * on the X2 platform.
 * 
 * Fixed module processes were introduced as part of X2 2.3
 * 
 * @author Christopher Stura "christopher.stura@cloudreach.com"
 */
public class TestFixedModule extends X2GSMTest {
	...
	public void testDefaultFixedModule() throws Throwable {
		...
		processBatch(0, 1.0, CCPluginManager.PluginManagerModule.class.getName());
