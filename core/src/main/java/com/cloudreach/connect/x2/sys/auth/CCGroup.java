 ...
 */
public class CCGroup implements SystemDBObject {
	...
	public CCGroup() {}
	public CCGroup(String name,String description,String locationPattern,int modStart,int modEnd) throws NoSuchAlgorithmException,UnsupportedEncodingException {
		this.name = name;
	...
	public CCGroup(String name,String description,int modStart,int modEnd,String... locations) throws NoSuchAlgorithmException,UnsupportedEncodingException {
		this.name = name;
		this.description = description;
		this.id = Util.md5(this.name.toUpperCase());
		this.module_id_start_range = modStart;
